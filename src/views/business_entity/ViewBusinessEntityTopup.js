...
const ViewBusinessEntityTopup = () => {
    ...
    const getlistBETopup = (page, perPage) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getAllBusinessEntityTopups?page=${page}&limit=${perPage}`, requestOptions)
    ...
    const handleSubmit = (e) => {
        try {
            ...
            if (selectedcompany.length == 0 || selectedcompany == undefined) {
                ...
                fetch(`https://insuranceapi-3o5t.onrender.com/api/addBusinessEntityTopup`, requestOptions)
                    .then(response => response.json())
                    .then(data => {
                        if (data.status == 201) {
                            setShowModal(false);
    ...
    const UpdateStatus = (id, status) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/UpdateBusinessEntityTopupStatus`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
    ...
    const becommissiondetails = (id) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getSingleBusinessEntityTopup?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const updateSubmit = (e) => {
        ...
        if (locationdata.length == 0 || locationdata == [] || locationdata == undefined) {
            ...
            fetch(`https://insuranceapi-3o5t.onrender.com/api/UpdateBusinessEntityTopup?id=${be_id}`, requestOptions)
                .then(response => response.json())
                .then(data => {
                    if (data.status === 200) {
    ...
    const deleteItem = async (id) => {
        ...
        await fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteMasterData?id=${id}&type=beTopup`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
