...
const Viewpropertytypelist = () => {
  ...
  const gethomepropertytype = async (page, perPage) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/get_home_property_type?page=${page}&limit=${perPage}`, requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const exportlistdata = () => {
    ...
    fetch('https://insuranceapi-3o5t.onrender.com/api/get_home_property_type', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, home_property_type_status) => {
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/update_home_property_type_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    await fetch("https://insuranceapi-3o5t.onrender.com/api/read_home_property_type_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addpropertytype = async (e) => {
    ...
    await fetch('https://insuranceapi-3o5t.onrender.com/api/add_home_property_type', {
      method: 'post',
      body: JSON.stringify({
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://insuranceapi-3o5t.onrender.com/api/get_home_property_type_detailsbyid`, requestOptions);
    result = await result.json();
  ...
  const updateHomepropertytypelist = async (e) => {
    ...
    await fetch(`https://insuranceapi-3o5t.onrender.com/api/update_home_property_type_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteHomeMaster/?id=${id}&type=homepropertytype`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
