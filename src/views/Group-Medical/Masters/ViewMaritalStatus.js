...
const ViewMaritalStatus = () => {
    ...
    const getMaritalStatusList = (page, limit) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getMaritalStatus?page=${page}&limit=${limit}`, reqOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const AddMaritalStatus = (e) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/addMaritalStatus`, reqOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 201) {
                    getMaritalStatusList(page, perPage);
    ...
    const goTosetShowEditModal = (id) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getMaritalStatusbyid?id=${id}`, reqOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const EditMaritalStatus = (e) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/updateMaritalStatus?id=${editData?._id}`, reqOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 200) {
    ...
    const ActivateDeactivate = (id, status) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/updateMaritalStatus?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 200) {
                    swal({
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteGroupMedicalMaster?id=${id}&type=MaritalStatus`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status === 200) {
                    swal({
