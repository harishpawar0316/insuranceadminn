...
const ViewRelation = () => {
  ...
  const getRelation = (page, limit) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/getRelation?page=${page}&limit=${limit}`, reqOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const AddRelation = (e) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/addRelation`, reqOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 201) {
          getRelation(page, perPage);
  ...
  const goTosetShowEditModal = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/getRelationbyid?id=${id}`, reqOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const EditRelation = (e) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/updateRelation?id=${editData?._id}`, reqOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 200) {
  ...
  const ActivateDeactivate = (id, status) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/updateRelation?id=${id}`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status == 200) {
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteGroupMedicalMaster?id=${id}&type=Relation`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
