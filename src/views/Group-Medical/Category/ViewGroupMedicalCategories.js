...
const ViewGroupMedicalCategories = () => {
    ...
    const GetGroupMedicalCategories = async (page, perpage) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getGroupMedicalCategories?page=${page}&limit=${perpage}`, reqOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const AddGroupMedicalCategory = async (e) => {
        ...
        fetch('https://insuranceapi-3o5t.onrender.com/api/addGroupmedicalCategory', reqOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 201) {
    ...
    const ActivateDeactivate = (id, status) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/updateGroupMedicalCategory?id=${id}`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 200) {
    ...
    const deleteItem = (id) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteGroupMedicalMaster?id=${id}&type=groupmedicalCategory`, requestOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 200) {
                    swal("Success", data.message, "success")
    ...
    const goTosetShowEditModal = (id) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/getGroupMedicalCategoryById?id=${id}`, reqOptions)
            .then(response => response.json())
            .then(data => {
    ...
    const EditCategory = async (e) => {
        ...
        fetch(`https://insuranceapi-3o5t.onrender.com/api/updateGroupMedicalCategory?id=${editData?._id}`, reqOptions)
            .then(response => response.json())
            .then(data => {
                if (data.status == 200) {
