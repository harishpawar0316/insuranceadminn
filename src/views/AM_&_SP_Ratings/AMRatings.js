...
const AMRatings = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`https://insuranceapi-3o5t.onrender.com/api/amRating`, reqdata)
            .then((data) => {
                if (data.status == 201) {
                    setShowModal(false)
                    swal({
    ...
    const updatestatus = async (id, status) => {
        ...
        axios.post('https://insuranceapi-3o5t.onrender.com/api/updateRatingStatus', data)
            .then((data) => {
                if (data.status == 200) {
                    setShowModal(false)
                    getAll_AM_Ratings(page, perPage)
    ...
    const getAll_AM_Ratings = (page, perPage) => {
        ...
        try {
            axios.get(`https://insuranceapi-3o5t.onrender.com/api/getAllamRatings?page=${page}&perPage=${perPage}`)
                // .then((res) => res.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const getSingleRating = (id) => {
        try {
            axios.get(`https://insuranceapi-3o5t.onrender.com/api/getsingleAmRating/${id}`)
                // .then((res) => res.json())
                .then((data) => {
                    if (data.status == 200) {
    ...
    const handleUpdate = (e) => {
        ...
        axios.put(`https://insuranceapi-3o5t.onrender.com/api/UpdatAMRating/?id=${updateId}`, reqdata)
            // .then((res) => res.json())
            .then((data) => {
                if (data.status == 200) {
