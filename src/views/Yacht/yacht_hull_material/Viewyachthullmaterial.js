...
const Viewyachthullmaterial = () => {
  ...
  const getYachthullmaterial = async (page, perPage) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/get_Yacht_hull_material?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const exportlistdata = () => {
    ...
    fetch('https://insuranceapi-3o5t.onrender.com/api/get_Yacht_hull_material', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, yacht_hull_material_status) => {
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/update_Yacht_hull_material_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    await fetch("https://insuranceapi-3o5t.onrender.com/api/read_Yacht_hull_material_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addyachthullmaterial = async (e) => {
    ...
    await fetch('https://insuranceapi-3o5t.onrender.com/api/add_Yacht_hull_material', {
      method: 'post',
      body: JSON.stringify({
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://insuranceapi-3o5t.onrender.com/api/get_Yacht_hull_material_detailsbyid`, requestOptions);
    result = await result.json();
  ...
  const updateyachtbodytypelist = async (e) => {
    ...
    await fetch(`https://insuranceapi-3o5t.onrender.com/api/update_Yacht_hull_material_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteYachtMaster/?id=${id}&type=yachthullmaterial`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
