...
const Viewyachthorsepowerlist = () => {
  ...
  const getYachthorsepower = async (page, perPage) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/get_Yacht_horespower_type?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const updatestatus = async (id, yacht_horsepower_type_status) => {
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/update_Yacht_horespower_type_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    await fetch("https://insuranceapi-3o5t.onrender.com/api/read_Yacht_horespower_type_excel ",
      {
        method: "post",
        body: fd,
      })
  ...
  const addyachthorsepower = async (e) => {
    ...
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/add_Yacht_horespower_type', {
      method: 'post',
  ...
  const detailsbyid = async (ParamValue) => {
    ...
    let result = await fetch(`https://insuranceapi-3o5t.onrender.com/api/get_Yacht_horespower_type_detailsbyid`, requestOptions);
    result = await result.json();
  ...
  const updateyachthorsepower = async (e) => {
    ...
    await fetch(`https://insuranceapi-3o5t.onrender.com/api/update_Yacht_horespower_type_details`, {
      method: "POST",
      body: JSON.stringify({
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteYachtMaster/?id=${id}&type=yachthorsepower`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
