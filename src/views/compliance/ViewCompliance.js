...
const ViewCompliance = () => {
  ...
  const getcompliance = (page, perPage) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/customerComplaints?limit=${perPage}&page=${page}`, requestOptions)
  ...
  const sendEmail = () => {
    ...
    // return false;
    fetch('https://insuranceapi-3o5t.onrender.com/api/UpdateComplaintStatus', {
      method: 'put',
      body: fd,
      headers: {
