...
const Viewmedicalvisacountries = () => {
  ...
  const getmedicalvisacountry = async (page, perPage) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/get_medical_visa_country?page=${page}&limit=${perPage}`, requestOptions)
  ...
  const exportlistdata = () => {
    ...
    fetch('https://insuranceapi-3o5t.onrender.com/api/get_medical_visa_country', requestOptions)
      .then(response => response.json())
      .then(data => {
  ...
  const updatestatus = async (id, medical_visa_country_status) => {
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/update_medical_visa_country_status', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const collectExceldata = async (e) => {
    ...
    let result = await fetch("https://insuranceapi-3o5t.onrender.com/api/read_medical_visa_country_excel ",//
      {
        method: "post",
        body: fd,
      })
  ...
  const addmedicalvisacountry = async (e) => {
    ...
    let result = await fetch('https://insuranceapi-3o5t.onrender.com/api/add_medical_visa_country', {
      method: 'post',
  ...
  const deleteItem = (id) => {
    ...
    fetch(`https://insuranceapi-3o5t.onrender.com/api/deleteMedicalMaster/?id=${id}&type=emiratesVisa`, requestOptions)
      .then(response => response.json())
      .then(data => {
        if (data.status === 200) {
          swal({
