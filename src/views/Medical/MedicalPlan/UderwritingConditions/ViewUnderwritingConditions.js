...
const ViewUnderwrintingConditions = () => {
  ...
  const getUnderwritingConditions = async (id) => {
    ...
    await fetch(`https://insuranceapi-3o5t.onrender.com/api/get_underwriting_conditions`, requestOptions)
  ...
  const handleSubmit = (e) => {
    ...
    if (hasNoStatus) {
      ...
      fetch(`https://insuranceapi-3o5t.onrender.com/api/add_underwriting_conditions`, requestOptions)
        .then(response => response.json())
        .then(data => {
